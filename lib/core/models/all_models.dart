...
class PurchaseInvoiceLine {
  ...
  PurchaseInvoiceLine({required this.id, required this.purchaseInvoiceId, required this.rawMaterialId, this.quantite, this.prixUnitaire, this.montantLigne, this.rawMaterialName});
